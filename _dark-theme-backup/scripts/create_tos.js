...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      new Paragraph({
        numbering: { reference: "numbers", level: 0 },
        children: [new TextRun("Platform Access (Free): Users and Experts may join the EzoraAI platform at no cost. Optional premium features and tools may be available at published prices. All payments are on a pay-per-session basis.")]
      }),
      new Paragraph({
        numbering: { reference: "numbers", level: 0 },
      ...
      new Paragraph({
        numbering: { reference: "numbers", level: 0 },
        children: [new TextRun("Premium Service Cancellation: Optional premium features and tools may be canceled at any time through your account settings. Cancellations take effect immediately.")]
      }),
      new Paragraph({
        numbering: { reference: "numbers", level: 0 },

...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      new Paragraph({
        children: [
          new TextRun("We partner with Stripe for secure payment processing. When you complete a session payment or transaction, we collect:")
        ],
        spacing: { after: 80 }
      }),
      ...
      new Paragraph({
        numbering: { reference: "numbers", level: 0 },
        children: [new TextRun("Transaction history and payment records")]
      }),
      ...
      new Paragraph({
        numbering: { reference: "numbers", level: 0 },
        children: [new TextRun("Process session payments and transaction fees")]
      }),
      ...
      new Paragraph({
        ...
        children: [new TextRun({
          text: "Stripe: ",
          bold: true
        }), new TextRun("Payment processing, transaction management, and payout distribution. Stripe maintains PCI-DSS compliance.")]
      }),
      ...
      new Paragraph({
        children: [
          new TextRun("Payment processing and transaction management. See Stripe&#x2019;s Privacy Policy at https://stripe.com/privacy.")
        ],
        spacing: { after: 120 }
      }),

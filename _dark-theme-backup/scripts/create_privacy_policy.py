...
add_text(doc, "We partner with Stripe for secure payment processing. When you complete a session payment or transaction, we collect:")
...
add_bullet(doc, "Transaction history and payment records")
...
add_bullet(doc, "Process session payments and transaction fees")
...
run.bold = True
para.add_run("Payment processing, transaction management, and payout distribution. Stripe maintains PCI-DSS compliance.")
para.paragraph_format.space_after = Pt(4)
...
add_text(doc, "Payment processing and transaction management. See Stripe's Privacy Policy at https://stripe.com/privacy.")

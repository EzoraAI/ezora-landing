...
const solutions = [
  ...
  },
  {
    ...
    subtitle: "(Fiverr)",
    items: ["AI agents & services for sale", "1-on-1 coaching sessions", "Pay-per-session pricing"]
  },
  {
...
const layer2Items = [
  "Optional premium features: featured placement, advanced analytics, priority support",
  "Benefits: discounted session rates, priority booking, exclusive content",
  "Target: 20-30% of active users opt in within 60 days"
];
...
const layer3Items = [
  "Expert premium tools (Phase 2)",
  "Featured placement, advanced analytics, promoted profiles",
...
const comparisonData = [
  ...
  ["User cost to start", "$500 deposit + $79/mo", "Free to join"],
  ["Expert cost", "Free (loses 40–60% markup)", "Free (sets own rates)"],

...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        children: [new TextRun("Provide advance notice if unable to attend, with reasonable cancellation windows per your subscription terms")]
      }),
      ...
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        children: [new TextRun("All payments must reflect genuine services or subscriptions")]
        , spacing: { after: 240 }
      }),
      ...
      new Paragraph({
        numbering: { reference: "bullets", level: 0 },
        children: [new TextRun("Existing sessions and subscriptions may be paused")]
      }),
